...
Checkout the Funcoin Core version you'd like to build:
...
- Update other repositories and websites for new version
  ...
  - bitcoincore.org RPC documentation update
      ...
      - Install the new Funcoin Core release
...
- Announce the release:
  ...
  - Funcoin Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - Funcoin Core Twitter https://twitter.com/bitcoincoreorg

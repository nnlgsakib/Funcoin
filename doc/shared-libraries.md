...
The purpose of this library is to make the verification functionality that is critical to Funcoin's consensus available to other applications, e.g. to language bindings.
...
- [NFuncoin](https://github.com/MetacoSA/NFuncoin/blob/5e1055cd7c4186dee4227c344af8892aea54faec/NFuncoin/Script.cs#L979-#L1031) (.NET Bindings)

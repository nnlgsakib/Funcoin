# Support for Output Descriptors in Funcoin Core

Since Funcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Funcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Funcoin Core descriptor wallet to serve as your
...
existing Funcoin Core wallets, a convenience function `combo` is
...
All RPCs in Funcoin Core will include the checksum in their output. Only

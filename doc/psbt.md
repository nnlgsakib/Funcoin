# PSBT Howto for Funcoin Core

Since Funcoin Core 0.17, an RPC interface exists for Partially Signed Funcoin
...
PSBT is an interchange format for Funcoin transactions that are not fully signed
...
#### Multisig with multiple Funcoin Core instances
...
Funcoin Core. We assume their wallets only contain the multisig funds. In case
...
Later, when *V* FUN has been received on *Amulti*, and Bob and Carol want to

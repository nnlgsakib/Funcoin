Funcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Funcoin/bitcoin-0.8.4/
...
code, causing the Funcoin-Qt or bitcoind process to crash.
...
their own version of Funcoin against Boost versions 1.50-1.52.

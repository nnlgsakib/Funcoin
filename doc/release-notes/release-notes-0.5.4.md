Funcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Funcoin/bitcoin-0.5.4/
...
Fix Funcoin-Qt notifications under Growl 1.3.
Increase required age of Funcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFuncoin properly when installing Funcoin-Qt over it. (Windows)

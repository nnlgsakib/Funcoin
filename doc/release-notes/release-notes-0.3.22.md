Download URL: https://sourceforge.net/projects/bitcoin/files/Funcoin/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FUN fee schedule (users still pay 0.01 FUN per kb, until next version)

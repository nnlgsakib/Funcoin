Funcoin Core version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of Funcoin Core
...
proposed parameters, a future release of Funcoin Core is expected that
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use FUN/kB (MarcoFalke)
...
- #8207 `f7a403b` Add a link to the Funcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Funcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)

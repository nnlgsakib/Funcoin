Funcoin Core version 0.16.0 is now available from:
...
Funcoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Funcoin Core is now 4.8. No effort will be
...
GUI changes
-----------
- Uses of "µFUN" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
- #12035 `eeb6d52` Change µFUN to bits (jb55)

...
options specified in the init files (e.g. setting `FUNCOIND_DATADIR` for
OpenRC).

### macOS

    Binary:              /usr/local/bin/bitcoind
    Configuration file:  ~/Library/Application Support/Funcoin/bitcoin.conf
    Data directory:      ~/Library/Application Support/Funcoin
    Lock file:           ~/Library/Application Support/Funcoin/.lock

...
//! Entry point for FuncoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &FuncoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for FuncoinGUI tests.
void AppTests::guiTests(FuncoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &FuncoinGUI::consoleShown, this, &AppTests::consoleTests);

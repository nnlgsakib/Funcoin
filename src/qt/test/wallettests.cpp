// Copyright (c) 2015-2021 The Funcoin Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FuncoinAmountField*>("payAmount")->setValue(amount);
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = FuncoinUnits::formatWithUnit(unit, expected_balance, false, FuncoinUnits::SeparatorStyle::ALWAYS);
...
void TestGUI(interfaces::Node& node)
{
    ...
    // Amount input
    FuncoinAmountField* amountInput = receiveCoinsDialog.findChild<FuncoinAmountField*>("reqAmount");

    ...
    mapper(nullptr)
{
    ...
    ui->openFuncoinConfButton->setToolTip(ui->openFuncoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new FuncoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSFUNontrols);
...
void OptionsDialog::on_openFuncoinConfButton_clicked()
{

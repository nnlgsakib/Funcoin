...
#ifndef FUNCOIN_TEST_SCRIPTNUM10_H
#define FUNCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Funcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // FUNCOIN_TEST_SCRIPTNUM10_H

// Copyright (c) 2019-2020 The Funcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FUNCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define FUNCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // FUNCOIN_TEST_UTIL_TRANSACTION_UTILS_H

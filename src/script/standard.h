...
#ifndef FUNCOIN_SCRIPT_STANDARD_H
#define FUNCOIN_SCRIPT_STANDARD_H
...
/**
 * Generate a Funcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FUNCOIN_SCRIPT_STANDARD_H

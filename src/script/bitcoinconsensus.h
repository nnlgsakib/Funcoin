...
// Copyright (c) 2009-2020 The Funcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FUNCOIN_SCRIPT_FUNCOINCONSENSUS_H
#define FUNCOIN_SCRIPT_FUNCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_FUNCOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBFUNCOINCONSENSUS)
...
#define FUNCOINCONSENSUS_API_VER 1
...
#endif // FUNCOIN_SCRIPT_FUNCOINCONSENSUS_H

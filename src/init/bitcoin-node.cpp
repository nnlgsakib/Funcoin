...
class FuncoinNodeInit : public interfaces::Init
{
public:
    FuncoinNodeInit(node::NodeContext& node, const char* arg0)
        : m_node(node),
...
{
    auto init = std::make_unique<init::FuncoinNodeInit>(node, argc > 0 ? argv[0] : "");

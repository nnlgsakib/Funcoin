...
#ifndef FUNCOIN_UTIL_SYSCALL_SANDBOX_H
#define FUNCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoind initialization if Funcoin Core was compiled
...
#endif // FUNCOIN_UTIL_SYSCALL_SANDBOX_H

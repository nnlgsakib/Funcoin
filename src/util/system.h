 ...
 */
#ifndef FUNCOIN_UTIL_SYSTEM_H
#define FUNCOIN_UTIL_SYSTEM_H
...
extern const char * const FUNCOIN_CONF_FILENAME;
extern const char * const FUNCOIN_SETTINGS_FILENAME;

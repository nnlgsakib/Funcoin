...
// Copyright 2015 Funcoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_H

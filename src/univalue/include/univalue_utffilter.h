...
#ifndef FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // FUNCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H

...
#ifndef FUNCOIN_NODE_CONNECTION_TYPES_H
#define FUNCOIN_NODE_CONNECTION_TYPES_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Funcoin’s Peer-to-Peer Network")
...
#endif // FUNCOIN_NODE_CONNECTION_TYPES_H

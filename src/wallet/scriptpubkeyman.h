...
#ifndef FUNCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define FUNCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Funcoin Core wallet was originally a collection of unrelated private
...
#endif // FUNCOIN_WALLET_SCRIPTPUBKEYMAN_H

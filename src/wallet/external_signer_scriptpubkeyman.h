...
#ifndef FUNCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define FUNCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // FUNCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

...
First, in terms of structure, there is no particular concept of "Funcoin Core
...
Before you start contributing, familiarize yourself with the Funcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Funcoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Funcoin Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Funcoin Core development happens on IRC, in the
...
fork of Funcoin Core copies the merge. Instead, make any username mentions in a

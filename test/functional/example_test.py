...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FuncoinTestFramework
    pass


class ExampleTest(FuncoinTestFramework):
    # Each functional test is a subclass of the FuncoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FuncoinTestFramework class so other tests can use it."""

...
class TxnMallTest(FuncoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 FUN:
        ...
        # First: use raw transaction API to send 1240 FUN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 FUN coin each
        ...
        # Node0's balance should be starting balance, plus 50FUN for another
        ...
        # Node0's total balance should be starting balance, plus 100FUN for

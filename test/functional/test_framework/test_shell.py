...
class TestShell:
    """Wrapper Class for FuncoinTestFramework.

    The TestShell class extends the FuncoinTestFramework
    ...
    class __TestShell(FuncoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by FuncoinTestFramework child class.
            self.num_nodes = 1

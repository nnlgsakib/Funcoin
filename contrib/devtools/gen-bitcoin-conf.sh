...
FUNCOIND=${FUNCOIND:-$BINDIR/bitcoind}
...
DIRTY=""
VERSION_OUTPUT=$($FUNCOIND --version)
if [[ $VERSION_OUTPUT == *"dirty"* ]]; then
  DIRTY="${DIRTY}${FUNCOIND}\n"
fi

if [ -n "$DIRTY" ]
then
  echo -e "WARNING: $FUNCOIND was built from a dirty tree.\n"
  echo -e "To safely generate a bitcoin.conf file, please commit your changes to $FUNCOIND, rebuild, then run this script again.\n"
fi

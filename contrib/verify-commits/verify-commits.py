#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Funcoin Core developers
...
def main():
    ...
    while True:
        ...
        os.environ['FUNCOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
        os.environ['FUNCOIN_VERIFY_COMMITS_ALLOW_REVSIG'] = "1" if current_commit in revsig_allowed else "0"

...
Tracing (USDT) support for Funcoin Core on Linux using. For more information on
USDT support in Funcoin Core see the [USDT documentation].
...
[Funcoin Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Funcoin Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
Funcoin P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting Funcoin Core in SigNet mode and with
re-indexing enabled.

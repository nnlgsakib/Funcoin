# Bootstrappable Funcoin Core Builds

This directory contains the files necessary to perform bootstrappable Funcoin
Core builds.
...
To build Funcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Funcoin Core version being built.
